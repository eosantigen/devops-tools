...
user = "" # gets a value at a later stage through iteration
...
# Execute the request for each user
def gf_request(user: str, gf_role: str, gf_org_id: int):
...
def add_admins(gf_org_id):
    ...
    for user in fetch_admins():
        gf_request(user, gf_role, gf_org_id)
