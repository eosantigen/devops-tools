...
# README #
# After you execute the above script, do:
# docker exec -it <regsitry-pod> bin/registry garbage-collect /etc/docker/registry/config.yml
# in order to actually clear up / do GC.

# LIVINGDAYS=${1-150}
DOCKER_REGISTRY="https://dockerreg.devanet/v2"
